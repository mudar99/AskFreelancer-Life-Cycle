...
import { SendAccountConfirmation, ResetPasswordAPI, ChangePasswordAPI } from '../../API';
...
class ChangePassword extends Component {
    ...
    ChangePassword = (e) => {
        ...
        axios.post(ChangePasswordAPI, params).then(
            res => {
    ...
    ChangePasswordVer = (e) => {
        ...
        axios.post(ResetPasswordAPI, params).then(
            res => {
                if (res.data.status == true) {
                    console.log(res.data)
                    this.showSuccess(res.data.message);
