            ...
            <form onSubmit={this.ChangePassword}>
                ...
                <div className="form-group wrapper" >
                    ...
                    <div className=" mt-3">
                        ...
                        <input className="form-control " onChange={e => this.setState({ oldPassword: e.target.value })} placeholder="Enter old password" required />
                    </div>
                    <div className=" mt-3">
                        <h6 className="mt-2 text-right">
                            :أدخل كلمة المرور الجديدة
                        </h6>
                        <input className="form-control " onChange={e => this.setState({ newPassword: e.target.value })} placeholder="Enter new password" required />
                    </div>
                    <div className=" mt-3">
                        <h6 className="mt-2 text-right">
